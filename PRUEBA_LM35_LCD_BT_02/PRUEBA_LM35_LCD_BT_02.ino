...
int TEMP_COMEDOR; //si no utilizamos decimales podria de byte o int, con int nos aseguramos de que no fallamos
...
int TEMP_HABITACION; //si no utilizamos decimales podria de byte o int, con int nos aseguramos de que no fallamos
...
TEMP_COMEDOR = ( VR_LM35_HABITACION *500 / 1024 ) ; // si dividimos entre 1024 resultado es INT, entre 1024.0 resultado es LONG
Serial.print ( "  -->  Temperatura : ");
...
if (comando_bt == "0A2") {
    ...
    Linea4 = "SENS TMP OFF HABITACION";
    scroll_lcd();
    }
...
if (Config_LM35_COMEDOR) {
      ...
      if ((TEMP_COMEDOR < 15) and (TEMP_COMEDOR > 30)) {
...
if (Config_LM35_HABITACION) {
      ...
      if ((TEMP_HABITACION < 15) and (TEMP_HABITACION > 30)) {
  ...
  //===================COMEDOR================================
      ...
      if (TEMP_CONFIG_LM35_COMEDOR != TEMP_CONFIG_LM35_COMEDOR_ANTES) {
        if (TEMP_CONFIG_LM35_COMEDOR = 1) {
          ...
          Serial.println ("  Aire Acondicionado ON");
       ...
       if (TEMP_CONFIG_LM35_COMEDOR = 2) {
          ...
          Serial.print( HORA_ACTUAL);
          Serial.print (TEMPERATURA_COMEDOR);
          Serial.println ("  TEMPERATURA ESTABILIZADA: AA + CC OFF");
     
          Linea4 = HORA_ACTUAL;
          scroll_lcd();
          Linea4 = "  TEMP ESTABILIZADA ";
          }
      if (TEMP_CONFIG_LM35_COMEDOR = 3) {
          ...
          Linea4 = HORA_ACTUAL;
          scroll_lcd();
          Linea4 = "    AA COMEDOR OFF  ";
          Serial1.println (BT_TEMP_COMEDOR);
          }
      }
      BT_TEMP_COMEDOR = "";
      comando_enviado_bt = comando_bt;
       comando_bt="";  //la limpieza del comando leido tiene que ir detras de asignar el comando
      ...
      if (TEMP_CONFIG_LM35_HABITACION = 3) {
          BT_TEMP_HABITACION = HORA_ACTUAL + "CC COMEDOR ON";
          digitalWrite(LED_AA_HABITACION, LOW);
