...
void setup()
{
  ...
  pinMode (IRFLAME_COMEDOR, INPUT ); //SENSOR FUEGO
...
void loop()
{
 ...
 comando_bt = comando_bt + comando_bt_recivido;
    ...
    SENSOR_IRFLAME_COMEDOR = digitalRead (IRFLAME_COMEDOR);  //LEEMOS EL SENSOR SI HAY MOVIMIENTO O NO
         ...
         HORA_ACTUAL = HORA_ACTUAL + "   ";
           ...
           Linea4 = "ALARMA FUEGO COM OFF";
            ...
            Serial.print ( HORA_ACTUAL );
            Serial.println ("ALARMA FUEGO ON");
           ...
           Serial1.println (comando_enviado_bt);
            ...
            Linea4 = "ALARMA FUEGO COM ON ";
             ...
             scroll_lcd ();
            SENSOR_IRFLAME_COMEDOR = SENSOR_IRFLAME_COMEDOR_ANTES;  // cambiamos el valor de la variable del sensor para que la lectura actual al siguiente loop sea la anterior
          }
  }
