...
{
  delay (500);
  float TEMP_COMEDOR = VR_LM35_COMEDOR *500 / 1024.0;
  float TMP_C = VR_LM35_COMEDOR *500 / 1024.0;
  float VR_LM35_COMEDOR = analogRead(LM35_COMEDOR);
 TEMPERATURA_COMEDOR = String(TEMP_COMEDOR)+ "ºC";
  ...
  if (comando_bt == "0A1") 
 {
  ...
  //=========SENSOR TEMPERATURA COMEDOR==============
   if (Config_LM35_COMEDOR) 
   {
     ...
     if ((TMP_C < 15) and (TEMP_COMEDOR > 30)) 
     {
